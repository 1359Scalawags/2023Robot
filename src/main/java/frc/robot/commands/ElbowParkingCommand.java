...
public class ElbowParkingCommand extends CommandBase {
   ...
   */
  public ElbowParkingCommand(ArmSubsystem subsystem) {
  ...
  public boolean isFinished() {
    return m_subsystem.isElbowAtTarget(Constants.Arm.Elbow.parkingDegree, Constants.Arm.Elbow.tolerance);
  }
}
