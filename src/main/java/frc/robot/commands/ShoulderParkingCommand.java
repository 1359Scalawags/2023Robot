...
public class ShoulderParkingCommand extends CommandBase {
   ...
   */
  public ShoulderParkingCommand(ArmSubsystem subsystem) {
  ...
  public boolean isFinished() {
    return m_subsystem.isShoulderAtTarget(Constants.Arm.Shoulder.parkingDegree, Constants.Arm.Shoulder.tolerance);
  }
}
