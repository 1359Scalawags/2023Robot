...
{
    public BlueStationTHREE(DrivetrainSubsystem m_DrivetrainSubsystem, ArmSubsystem m_ArmSubsystem, GrabberSubsystem m_GrabberSubsystem)
    {
        ...
        addCommands(
            ...
            m_DrivetrainSubsystem.followTrajectoryCommand(m_DrivetrainSubsystem.getBlue3ToCenter(), true),

            new GrabGamePieceOnGround(m_ArmSubsystem, m_GrabberSubsystem),

            m_DrivetrainSubsystem.followTrajectoryCommand(m_DrivetrainSubsystem.getCenterToBlue3(), true),
