...
public class LoadGamepieceOnGroundLevel extends SequentialCommandGroup{
    public LoadGamepieceOnGroundLevel(ArmSubsystem m_ArmSubsystem, GrabberSubsystem m_GrabberSubsystem){
        addCommands(
            ...
            new ArmOnGroundLevelCommand(m_ArmSubsystem),
