...
public class GravityAssistFeedForward {
     ...
     */
    public GravityAssistFeedForward(double gravityFF, double offsetAngle) {
     ...
     * @param offsetAngle Angle of the mechanism when horisontal (and positive change in angle results in upward motion).
     */
    public GravityAssistFeedForward(double minimumFF, double gravityFF, double offsetAngle) {
     ...
     */
    public GravityAssistFeedForward(double minimumFF, double gravityFF, double offsetAngle, boolean reversed) {
